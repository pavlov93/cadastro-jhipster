package cadastro.myapp.web.rest;

import cadastro.myapp.RegistrodecadastroApp;
import cadastro.myapp.config.Constants;
import cadastro.myapp.domain.Authority;
import cadastro.myapp.domain.User;
import cadastro.myapp.repository.AuthorityRepository;
import cadastro.myapp.repository.UserRepository;
import cadastro.myapp.security.AuthoritiesConstants;
import cadastro.myapp.service.MailService;
import cadastro.myapp.service.UserService;
import cadastro.myapp.service.dto.PasswordChangeDTO;
import cadastro.myapp.service.dto.UserDTO;
import cadastro.myapp.web.rest.errors.ExceptionTranslator;
import cadastro.myapp.web.rest.vm.KeyAndPasswordVM;
import cadastro.myapp.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = RegistrodecadastroApp.class)

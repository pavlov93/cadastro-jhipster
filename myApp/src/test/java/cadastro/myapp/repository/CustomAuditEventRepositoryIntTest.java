package cadastro.myapp.repository;

import cadastro.myapp.RegistrodecadastroApp;
import cadastro.myapp.config.Constants;
import cadastro.myapp.config.audit.AuditEventConverter;
import cadastro.myapp.domain.PersistentAuditEvent;
...
import static cadastro.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
